...
import math
from modeling_SigLIP import SiglipVisionConfig, SiglipVisonModel
...
class GemmaModel(nn.Module):
    def __init__(self, config: GemmaConfig):
        ...
        self.rmbed_tokens = nn.Embedding(config.vocab_size, config.hidden_size, self.padding_idx)
...
class GemmaForCasualLM(nn.Module):
    ...
    def tie_weights(self):
        self.lm.head.weight =self.model.embed_tokens.weight
    ...
    def forward(
        ...
        #creating logits from embeddings
...
class PalilGemmaMultiModalProjector(nn.Module):
...
class PaliGemmaForConditionalGeneration(nn.Module):
    ...
    def __init__(self, config: PaliGemmaConfig):
        super().__init__()
        self.config = config
        self.vision_tower = SiglipVisonModel(config.vision_config)
        self.multi_modal_projector = PalilGemmaMultiModalProjector(config)
        self.vocab_size = config.vocab_size
